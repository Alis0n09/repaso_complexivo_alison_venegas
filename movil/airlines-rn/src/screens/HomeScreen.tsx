...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable onPress={() => navigation.navigate("Airlines")} style={styles.btn}>
        <Text style={styles.btnText}>Airline (list/create/delete)</Text>
      </Pressable>

      <Pressable onPress={() => navigation.navigate("FlightEvents")} style={styles.btn}>
        <Text style={styles.btnText}>Flight Events (select + create/delete)</Text>
      </Pressable>
